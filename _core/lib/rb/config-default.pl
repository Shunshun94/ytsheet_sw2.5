...
## ●タイトル
  our $title = 'ゆとシートⅡ for ルーインブレイカーズ';
...
## ●各種ファイルへのパス
  ...
  our $admimail = 'shunshun94@hiyoko.example.com'; # 管理者（システムメール送信元）メールアドレス
  ...
  our $lib_edit_char   = $::core_dir . '/lib/rb/edit-chara.pl';
  # 保存処理
  our $lib_save        = $::core_dir . '/lib/save.pl';
  our $lib_calc_char   = $::core_dir . '/lib/rb/calc-chara.pl';
  # シート表示
  our $lib_view        = $::core_dir . '/lib/view.pl';
  our $lib_view_char   = $::core_dir . '/lib/rb/view-chara.pl';
  # チャットパレット
  our $lib_palette     = $::core_dir . '/lib/palette.pl';
  our $lib_palette_sub = $::core_dir . '/lib/rb/palette-sub.pl';
  # 一覧
  our $lib_list_char   = $::core_dir . '/lib/rb/list-chara.pl';
  # JSON出力
  our $lib_json     = $::core_dir . '/lib/json.pl';
  our $lib_json_sub = $::core_dir . '/lib/rb/json-sub.pl';
  # コンバート
  ...
  our $skin_sheet = $::core_dir . '/skin/rb/sheet-chara.html';   # キャラクターシート
