...
$data::class{'バトルダンサー'}{2.5} =
$data::class{'ドルイド'}{2.5} =
$data::class{'ジオマンサー'}{2.5} =
$data::class{'アビスゲイザー'}{2.5} =
$data::class{'ダークハンター'}{2.5} =
$data::class{'ビブリオマンサー'}{2.5} = 1;
